...
| `SBI_090`  | The SBI v3.0 Supervisor Software Events (SSE) extension MUST be implemented if the system supports Firmware-First RAS (Reliability, Availability, Servicability) feature.
|===
